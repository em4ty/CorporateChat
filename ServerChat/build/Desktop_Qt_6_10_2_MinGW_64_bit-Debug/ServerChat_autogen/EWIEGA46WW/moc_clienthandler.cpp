...
void ClientHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->newMessage((*reinterpret_cast<std::add_pointer_t<ChatMessage>>(_a[1]))); break;
        case 1: _t->clientReady((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ClientHandler::*)(const ChatMessage & )>(_a, &ClientHandler::newMessage, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ClientHandler::*)(const QString & )>(_a, &ClientHandler::clientReady, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (ClientHandler::*)(const QString & )>(_a, &ClientHandler::clientDisconnected, 2))
            return;
    }
}
...
// SIGNAL 0
void ClientHandler::newMessage(const ChatMessage & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void ClientHandler::clientReady(const QString & _t1)
{
